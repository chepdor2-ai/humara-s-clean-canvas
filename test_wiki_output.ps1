...
Write-Host ""
Write-Host "=== METRICS ==="
Write-Host "Words: $($response.metrics.wordCount)"
Write-Host "Sentences: $($response.metrics.sentenceCount)"  
Write-Host "AI Score: $($response.metrics.aiScore)"
Write-Host "Meaning: $($response.metrics.meaningSimilarity)"
