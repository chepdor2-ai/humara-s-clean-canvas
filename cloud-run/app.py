#!/usr/bin/env python3
"""
Google Cloud Run wrapper for oxygen_server.py
Adds Bearer-token authentication via GCR_API_SECRET environment variable.
"""
import os
import hmac
import logging
...
API_SECRET = os.environ.get("GCR_API_SECRET", "")


@app.get("/")
async def root():
    """Root endpoint — basic info page."""
    return {"service": "Oxygen T5 Humanizer (Cloud Run)", "status": "running", "docs": "/docs"}
