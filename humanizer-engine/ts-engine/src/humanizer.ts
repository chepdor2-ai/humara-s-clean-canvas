...
const NONSENSE_DOUBLE_SUFFIX = /(?:nesses|ments|tioned|tioning|sioned|sioning|shiped|shipping|mented|menting|lacksed|lacksing|ksed|ksing|ssed(?!ing)|(?:ves|nds|rks|lts|cts|pts|nts|mps|ngs)ed|(?<=[a-z]{2})inged)$/i;
