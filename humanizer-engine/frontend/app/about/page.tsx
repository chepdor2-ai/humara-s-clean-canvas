    ...
    <div className="flex flex-col items-center min-h-screen">
      <section className="w-full bg-brand-50 pt-32 pb-24">
        <div className="max-w-5xl mx-auto px-6 text-center mt-12">
          <span className="inline-block py-1 px-3 rounded-full bg-brand-100 text-brand-800 font-bold uppercase text-xs mb-6 border border-brand-300">Philosophy</span>
      ...
      <section className="w-full bg-white py-24 border-y border-brand-100">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-1 bg-brand-100 border border-brand-100 shadow-2xl">
            {[
              ...
              <div key={i} className="bg-white p-8 flex flex-col justify-center items-center text-center sketch-card">
                <item.icon className="w-8 h-8 text-brand-600 mb-4" />
                <h3 className="text-xs font-black uppercase tracking-widest text-gray-600 mb-2">{item.title}</h3>
      ...
      <section className="w-full py-24 px-6 bg-brand-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-4">Core Values</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-8 sketch-card space-y-4">
      ...
      <section className="w-full py-24 px-6 bg-gray-900 text-center">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          <Link href="/app" className="inline-block bg-brand-500 hover:bg-brand-600 text-white px-8 py-4 text-lg font-black sketch-btn transition">
