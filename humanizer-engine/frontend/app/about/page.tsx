...
export default function AboutPage() {
  return (
    <div className="flex flex-col items-center min-h-screen">
      ...
      <section className="w-full py-24 px-6 bg-red-950/20 border-y border-red-900/30">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white dark:bg-zinc-950 rounded-2xl border-2 border-red-900/50 p-8 md:p-12 mb-10">
            ...
            <div className="bg-red-950/30 border border-red-900/50 rounded-xl p-6">
              <h4 className="text-sm font-bold text-red-400 mb-2">Why We Enforce This Policy</h4>
