    ...
    <div className="flex flex-col items-center container-snap">
      ...
      <section className="w-full pt-20 sm:pt-32 pb-14 sm:pb-20 bg-white dark:bg-[#0a0a0b]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <div className="inline-flex items-center gap-2 py-1.5 px-3 rounded-full bg-brand-50 dark:bg-brand-950/40 text-brand-700 dark:text-brand-400 text-xs font-medium mb-6 sm:mb-8 border border-brand-200 dark:border-brand-800 badge-float">
      ...
      {/* ─── HUMANIZATION FLOW ─── */}
      <section className="w-full py-14 sm:py-20 bg-slate-50 dark:bg-zinc-900 border-y border-slate-100 dark:border-zinc-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            <div className="inline-flex items-center gap-2 py-1.5 px-3 rounded-full bg-brand-50 dark:bg-brand-950/40 text-brand-700 dark:text-brand-400 text-xs font-medium mb-4 sm:mb-6 border border-brand-200 dark:border-brand-800">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-[#0a0a0b] rounded-xl border border-slate-200 dark:border-zinc-800 p-4 sm:p-6 card-tilt">
              <div className="flex items-start gap-3 sm:gap-5">
                <div className="w-9 h-9 sm:w-12 sm:h-12 bg-brand-50 rounded-xl flex items-center justify-center shrink-0">
            ...
            <div className="bg-white dark:bg-[#0a0a0b] rounded-xl border border-slate-200 dark:border-zinc-800 p-4 sm:p-6 card-tilt">
              <div className="flex items-start gap-3 sm:gap-5">
                <div className="w-9 h-9 sm:w-12 sm:h-12 bg-red-50 rounded-xl flex items-center justify-center shrink-0">
                ...
                <div className="flex-1">
                  ...
                  <div className="bg-slate-50 dark:bg-zinc-900 rounded-lg border border-slate-100 dark:border-zinc-800 p-3 sm:p-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Turnitin', 'GPTZero', 'Originality.AI', 'Copyleaks', 'Winston AI', 'Sapling', 'Crossplag'].map(d => (
                        <span key={d} className="text-xs font-medium bg-white dark:bg-zinc-800 text-slate-600 dark:text-zinc-300 px-2 sm:px-3 py-1 rounded-md border border-slate-200 dark:border-zinc-700">{d}</span>
                      ))}
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white dark:bg-[#0a0a0b] rounded-xl border border-slate-200 dark:border-zinc-800 p-4 sm:p-6 card-tilt">
              <div className="flex items-start gap-3 sm:gap-5">
                <div className="w-9 h-9 sm:w-12 sm:h-12 bg-amber-50 rounded-xl flex items-center justify-center shrink-0">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid sm:grid-cols-2 gap-2 sm:gap-3">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-2 text-xs sm:text-sm text-slate-600 dark:text-zinc-400">
            ...
            <div className="bg-white dark:bg-[#0a0a0b] rounded-xl border border-slate-200 dark:border-zinc-800 p-4 sm:p-6 card-tilt">
              <div className="flex items-start gap-3 sm:gap-5">
                <div className="w-9 h-9 sm:w-12 sm:h-12 bg-violet-50 rounded-xl flex items-center justify-center shrink-0">
            ...
            <div className="bg-white dark:bg-[#0a0a0b] rounded-xl border border-slate-200 dark:border-zinc-800 p-4 sm:p-6 card-tilt">
              <div className="flex items-start gap-3 sm:gap-5">
                <div className="w-9 h-9 sm:w-12 sm:h-12 bg-emerald-50 rounded-xl flex items-center justify-center shrink-0">
      ...
      <section className="w-full py-14 sm:py-20 bg-white dark:bg-[#0a0a0b]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            <div className="inline-flex items-center gap-2 py-1.5 px-3 rounded-full bg-red-50 dark:bg-red-950/30 text-red-700 dark:text-red-400 text-xs font-medium mb-4 sm:mb-6 border border-red-200 dark:border-red-800">
          ...
          <div className="grid sm:grid-cols-3 gap-3 sm:gap-6">
            <div className="card-tilt bg-slate-50 dark:bg-zinc-900 rounded-xl border border-slate-100 dark:border-zinc-800 p-4 sm:p-6">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-brand-50 dark:bg-brand-950/40 rounded-lg flex items-center justify-center mb-3 sm:mb-4">
                <Send className="w-4 h-4 sm:w-5 sm:h-5 text-brand-600 dark:text-brand-400" />
              </div>
              <p className="text-xs font-semibold text-brand-600 dark:text-brand-400 uppercase tracking-widest mb-1.5 sm:mb-2">Step 1</p>
            ...
            <div className="card-tilt bg-slate-50 dark:bg-zinc-900 rounded-xl border border-slate-100 dark:border-zinc-800 p-4 sm:p-6">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-amber-50 dark:bg-amber-950/40 rounded-lg flex items-center justify-center mb-3 sm:mb-4">
                <RefreshCw className="w-4 h-4 sm:w-5 sm:h-5 text-amber-500 dark:text-amber-400" />
              </div>
              <p className="text-xs font-semibold text-brand-600 dark:text-brand-400 uppercase tracking-widest mb-1.5 sm:mb-2">Step 2</p>
            ...
            <div className="card-tilt bg-slate-50 dark:bg-zinc-900 rounded-xl border border-slate-100 dark:border-zinc-800 p-4 sm:p-6">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-emerald-50 dark:bg-emerald-950/40 rounded-lg flex items-center justify-center mb-3 sm:mb-4">
                <BarChart3 className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-500 dark:text-emerald-400" />
              </div>
              <p className="text-xs font-semibold text-brand-600 dark:text-brand-400 uppercase tracking-widest mb-1.5 sm:mb-2">Step 3</p>
      ...
      {/* CTA */}
      <section className="w-full py-14 sm:py-20 bg-slate-50 dark:bg-zinc-900 border-t border-slate-100 dark:border-zinc-800">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3">
            ...
            <Link href="/detector" className="bg-white dark:bg-zinc-800 hover:bg-slate-50 dark:hover:bg-zinc-700 text-slate-700 dark:text-zinc-300 px-7 py-3 rounded-full text-sm font-medium border border-slate-200 dark:border-zinc-700 transition-colors w-full sm:w-auto text-center">
              Try AI Detector
            </Link>
          </div>
        </div>
