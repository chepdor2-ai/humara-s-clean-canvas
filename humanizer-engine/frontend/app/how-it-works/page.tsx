...
export default function HowItWorksPage() {
  return (
    <div className="flex flex-col items-center container-snap">
      {/* Hero */}
      <section className="w-full pt-20 sm:pt-32 pb-14 sm:pb-20 bg-[#0a0a0b]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-semibold text-white tracking-tight leading-[1.1] mb-4 sm:mb-6 animate-fade-in-up">
            How HumaraGPT works
          </h1>
      ...
      {/* ─── HUMANIZATION FLOW ─── */}
      <section className="w-full py-14 sm:py-20 bg-zinc-900 border-y border-zinc-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold text-white mb-2 sm:mb-3">The humanization process</h2>
            <p className="text-sm sm:text-base text-zinc-400 max-w-xl mx-auto">What happens when you click &ldquo;Humanize&rdquo; — step by step.</p>
          </div>

          <div className="space-y-6">
            {/* Step 1: User pastes text */}
            <div className="bg-[#0a0a0b] rounded-xl border border-zinc-800 p-4 sm:p-6 card-tilt">
              <div className="flex items-start gap-3 sm:gap-5">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-xs text-zinc-500 bg-zinc-800 px-2 py-0.5 rounded">You &rarr; Frontend</span>
                  </div>
                  <h3 className="text-base sm:text-xl font-semibold text-white mb-1.5 sm:mb-2">You paste your AI-generated text</h3>
                  <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">You paste or type your text into the editor. You can choose an engine mode (Fast, Standard, or Stealth) depending on how aggressive the rewrite should be. The frontend sends your text, selected engine, and any style preferences to the backend API.</p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3 sm:gap-5">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-xs text-zinc-500 bg-zinc-800 px-2 py-0.5 rounded">Backend</span>
                  </div>
                  <h3 className="text-base sm:text-xl font-semibold text-white mb-1.5 sm:mb-2">Pre-detection scan (input analysis)</h3>
                  <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed mb-3 sm:mb-4">Before rewriting, the backend runs your original text through multiple AI detectors simultaneously. This establishes a &ldquo;before&rdquo; baseline score and identifies which sentences are most likely to be flagged as AI-written.</p>
                  <div className="bg-zinc-900 rounded-lg border border-zinc-800 p-3 sm:p-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Turnitin', 'GPTZero', 'Originality.AI', 'Copyleaks', 'Winston AI', 'Sapling', 'Crossplag'].map(d => (
                        <span key={d} className="text-xs font-medium bg-zinc-800 text-zinc-300 px-2 sm:px-3 py-1 rounded-md border border-zinc-700">{d}</span>
                      ))}
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-3 sm:gap-5">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-xs text-zinc-500 bg-zinc-800 px-2 py-0.5 rounded">Backend &middot; NLP Engine</span>
                  </div>
                  <h3 className="text-base sm:text-xl font-semibold text-white mb-1.5 sm:mb-2">Pattern analysis &amp; AI marker detection</h3>
              ...
              <div className="flex items-start gap-3 sm:gap-5">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-xs text-zinc-500 bg-zinc-800 px-2 py-0.5 rounded">Backend &middot; Rewrite Engine</span>
                  </div>
                  <h3 className="text-base sm:text-xl font-semibold text-white mb-1.5 sm:mb-2">Structural rewrite with burstiness</h3>
              ...
              <div className="flex items-start gap-3 sm:gap-5">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-xs text-zinc-500 bg-zinc-800 px-2 py-0.5 rounded">Backend &middot; Post-processor</span>
                  </div>
                  <h3 className="text-base sm:text-xl font-semibold text-white mb-1.5 sm:mb-2">Tone calibration &amp; style matching</h3>
                  <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">The rewritten text is fine-tuned to match your target style — academic, professional, or conversational. Perplexity adjustments create authentic human-like word distributions. A final polish pass ensures coherence, flow, and that the meaning similarity stays above 95%.</p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3 sm:gap-5">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-xs text-zinc-500 bg-zinc-800 px-2 py-0.5 rounded">Backend &rarr; You</span>
                  </div>
                  <h3 className="text-base sm:text-xl font-semibold text-white mb-1.5 sm:mb-2">Post-detection verification &amp; results</h3>
      ...
      {/* ─── AI DETECTION FLOW ─── */}
      <section className="w-full py-14 sm:py-20 bg-[#0a0a0b]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold text-white mb-2 sm:mb-3">The AI detection process</h2>
            <p className="text-sm sm:text-base text-zinc-400 max-w-xl mx-auto">How the standalone AI Detector works when you check any text.</p>
          </div>

          <div className="grid sm:grid-cols-3 gap-3 sm:gap-6">
            <div className="card-tilt bg-zinc-900 rounded-xl border border-zinc-800 p-4 sm:p-6">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-white mb-1.5 sm:mb-2">Submit text</h3>
              <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">Paste any text into the AI Detector to check it against multiple detectors.</p>
            </div>
            ...
            <div className="card-tilt bg-zinc-900 rounded-xl border border-zinc-800 p-4 sm:p-6">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-white mb-1.5 sm:mb-2">Multi-detector scan</h3>
              <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">7+ detectors run in parallel — Turnitin, GPTZero, Originality.AI, Copyleaks, and more.</p>
            </div>
            ...
            <div className="card-tilt bg-zinc-900 rounded-xl border border-zinc-800 p-4 sm:p-6">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-white mb-1.5 sm:mb-2">Aggregated results</h3>
              <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">Overall AI/human scores, per-detector breakdown, and a clear verdict.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA */}
      <section className="w-full py-14 sm:py-20 bg-zinc-900 border-t border-zinc-800">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-2xl sm:text-3xl font-semibold text-white mb-3 sm:mb-4">Try it yourself</h2>
          <p className="text-sm sm:text-base text-zinc-400 mb-6 sm:mb-8">Paste your text and see the full pipeline in action.</p>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3">
            ...
            <Link href="/detector" className="bg-zinc-800 hover:bg-zinc-700 text-zinc-300 px-7 py-3 rounded-full text-sm font-medium border border-zinc-700 transition-colors w-full sm:w-auto text-center">
              Try AI Detector
            </Link>
          </div>
        </div>
