    ...
    <div className="flex flex-col items-center min-h-screen bg-brand-950">
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-black text-gray-900">Service Usage</h2>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-black text-gray-900">Acceptable Content</h2>
              </div>
              <p className="text-gray-700 text-lg leading-relaxed font-medium">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-black text-gray-900">Data & Privacy</h2>
              </div>
              <p className="text-gray-700 text-lg leading-relaxed font-medium">
      ...
      <section className="w-full py-20 px-6 bg-brand-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-black text-gray-900 mb-6">Questions about our Terms?</h2>
