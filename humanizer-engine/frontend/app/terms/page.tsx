    ...
    <div className="flex flex-col items-center min-h-screen bg-[#05050A]">
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-white">Acceptable Content</h2>
              </div>
              <p className="text-zinc-300 text-lg leading-relaxed font-medium">
            ...
            {/* Last Updated */}
            <div className="border-t-2 border-zinc-800 pt-8 mt-8">
      ...
      <section className="w-full py-20 px-6 bg-zinc-900">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Questions about our Terms?</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/" className="bg-zinc-800 text-zinc-300 px-8 py-3 font-medium rounded-lg border border-zinc-700 hover:bg-zinc-700 transition-colors">
              Back to Home
            </Link>
          </div>
        </div>
