...
export default function PrivacyPage() {
  return (
    <div className="flex flex-col items-center min-h-screen bg-[#05050A]">
      {/* Hero Section */}
      <section className="w-full bg-zinc-900 pt-32 pb-24">
        <div className="max-w-5xl mx-auto px-6 text-center mt-12">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-8 border-b-4 border-purple-500 pb-6 inline-block">
            Privacy Policy
          </h1>
          <p className="text-xl text-zinc-400 max-w-3xl mx-auto font-medium leading-relaxed mt-8">
      ...
      {/* Main Content */}
      <section className="w-full bg-[#05050A] py-24 border-y border-zinc-800">
        <div className="max-w-4xl mx-auto px-6">
          <div className="space-y-12">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-zinc-800/50 border-l-4 border-purple-500 p-6 rounded-r-lg">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-white">Content Storage & Retention</h2>
              </div>
              <p className="text-zinc-300 text-lg leading-relaxed font-medium">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-white">Your Rights & Choices</h2>
              </div>
              <p className="text-zinc-300 text-lg leading-relaxed font-medium">
            ...
            <div className="border-t-2 border-zinc-700 pt-8 mt-8">
              <p className="text-center text-sm font-bold text-zinc-400 italic">
      ...
      <section className="w-full py-20 px-6 bg-zinc-900">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Your Privacy Matters</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/" className="bg-zinc-800 text-white px-8 py-3 font-medium rounded-lg border border-zinc-700 hover:bg-zinc-700 transition-colors">
              Back to Home
            </Link>
          </div>
        </div>
