...
export default function SignupPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen flex flex-col bg-[#05050A] relative overflow-hidden premium-dots">
        ...
        <main className="flex-grow flex items-center justify-center px-4 sm:px-6 py-12 relative z-10">
          <div className="w-full max-w-[420px]">
            <div className="bg-zinc-900/60 backdrop-blur-2xl rounded-2xl border border-zinc-800/80 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] p-8 sm:p-10 text-center">
    ...
    <div className="min-h-screen flex flex-col bg-[#05050A] relative overflow-hidden premium-dots">
      ...
      <main className="flex-grow flex items-center justify-center px-4 sm:px-6 py-12 relative z-10">
        <div className="w-full max-w-[420px]">
          ...
          {/* Card */}
          <div className="bg-zinc-900/60 backdrop-blur-2xl rounded-2xl border border-zinc-800/80 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] p-8 sm:p-10">
            <h1 className="text-[26px] font-bold text-center text-white tracking-tight">Create your account</h1>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white/[0.04] border border-zinc-700/60 hover:bg-white/[0.08] hover:border-zinc-600 text-zinc-200 font-medium py-3 rounded-xl transition-all disabled:opacity-50 text-sm"
            >
            ...
            <div className="relative my-7">
              <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-zinc-800/80" /></div>
              <div className="relative flex justify-center"><span className="bg-zinc-900 px-4 text-xs text-zinc-600 uppercase tracking-wider">or</span></div>
            </div>

            {/* Form */}
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block text-[13px] font-medium text-zinc-400 mb-2">Full Name</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 rounded-xl border border-zinc-800 bg-zinc-950/60 text-white placeholder-zinc-600 focus:border-purple-500/60 focus:ring-2 focus:ring-purple-500/10 focus:outline-none transition-all text-sm"
              ...
              <div>
                <label className="block text-[13px] font-medium text-zinc-400 mb-2">Email</label>
                <div className="relative">
              ...
              <div>
                <label className="block text-[13px] font-medium text-zinc-400 mb-2">Password</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-12 py-3 rounded-xl border border-zinc-800 bg-zinc-950/60 text-white placeholder-zinc-600 focus:border-purple-500/60 focus:ring-2 focus:ring-purple-500/10 focus:outline-none transition-all text-sm"
              ...
              <label className="flex items-start gap-3 cursor-pointer pt-1">
                <input
                  ...
                  className="mt-0.5 h-4 w-4 rounded border-zinc-700 bg-zinc-950 accent-purple-600 cursor-pointer"
                />
