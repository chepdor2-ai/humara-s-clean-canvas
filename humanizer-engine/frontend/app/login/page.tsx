...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#05050A] premium-dots">
      <main className="flex-grow">
        <section className="min-h-[85vh] flex items-center justify-center p-4 sm:p-6 relative">
          ...
          <div className="max-w-md w-full relative z-10">
            ...
            <div className="bg-zinc-900/90 backdrop-blur-2xl rounded-3xl border border-purple-500/10 shadow-2xl shadow-purple-900/20 p-7 sm:p-9">
              <h2 className="text-2xl font-bold text-center mb-1.5 text-white tracking-tight">Welcome back</h2>
              <p className="text-center text-zinc-400 text-sm mb-7">Sign in to continue to HumaraGPT</p>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-zinc-800/80 border border-zinc-700/80 hover:bg-zinc-700/80 text-zinc-200 font-medium py-3 rounded-xl transition-all disabled:opacity-50 text-sm mb-6 hover:border-purple-500/30"
              >
              ...
              <div className="relative mb-5">
                ...
                <div className="relative flex justify-center text-xs"><span className="bg-zinc-900 px-3 text-zinc-600">or</span></div>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 border border-zinc-700/80 rounded-xl bg-zinc-950/80 text-white placeholder-zinc-600 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 focus:outline-none transition-all text-sm"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-12 py-3 border border-zinc-700/80 rounded-xl bg-zinc-950/80 text-white placeholder-zinc-600 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 focus:outline-none transition-all text-sm"
                      placeholder=""
                      title="Password"
                      required
                    />
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-[#05050A]"><p className="text-zinc-500">Loading...</p></div>}>
      <LoginForm />
    </Suspense>
  );
}