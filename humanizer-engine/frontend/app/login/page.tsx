          ...
          <div className="max-w-md w-full relative z-10">
            ...
            <div className="bg-white/90 dark:bg-zinc-900/90 backdrop-blur-2xl rounded-3xl border border-purple-500/10 shadow-2xl shadow-purple-900/20 p-7 sm:p-9">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-slate-100 dark:bg-zinc-800/80 border border-slate-300 dark:border-zinc-700/80 hover:bg-zinc-700/80 text-zinc-200 font-medium py-3 rounded-xl transition-all disabled:opacity-50 text-sm mb-6 hover:border-purple-500/30"
              >
