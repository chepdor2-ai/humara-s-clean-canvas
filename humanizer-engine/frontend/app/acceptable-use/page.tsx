    ...
    <div className="flex flex-col items-center min-h-screen">
      ...
      <section className="w-full bg-zinc-950 py-24 border-y border-zinc-800">
        <div className="max-w-4xl mx-auto px-6 space-y-16">
          ...
          <div className="bg-red-950/20 border-2 border-red-900/50 rounded-2xl p-8 md:p-12">
            ...
            <h3 className="text-xl font-bold text-white mb-4">What is considered academic use?</h3>
            ...
            <h3 className="text-xl font-bold text-white mb-4">Why we prohibit academic use</h3>
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-3xl font-bold text-white">Permitted: Professional Uses</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={category.title} className="bg-zinc-900 rounded-xl border border-zinc-800 p-6">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <Ban className="w-8 h-8 text-red-400 flex-shrink-0" strokeWidth={2} />
              <h2 className="text-3xl font-bold text-white">Other Prohibited Uses</h2>
            </div>
            <p className="text-zinc-300 leading-relaxed mb-6">
          ...
          <div className="border-t-2 border-zinc-700 pt-8">
            ...
            <p className="text-center text-sm font-bold text-zinc-500 italic">
      ...
      <section className="w-full py-20 px-6 bg-zinc-900">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Ready for professional-grade content humanization?</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/terms" className="bg-zinc-950 text-white px-8 py-3 font-medium rounded-lg border border-zinc-700 hover:bg-zinc-900 transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
