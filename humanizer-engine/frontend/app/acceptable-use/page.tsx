    ...
    <div className="flex flex-col items-center min-h-screen">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center mt-12">
          <div className="flex justify-center mb-6">
            <div className="p-3 bg-brand-50 dark:bg-brand-950/30 rounded-xl">
              <Shield className="w-8 h-8 text-brand-600 dark:text-brand-400" strokeWidth={2} />
            </div>
          </div>
      ...
      <section className="w-full bg-white dark:bg-zinc-950 py-24 border-y border-brand-100 dark:border-zinc-800">
        <div className="max-w-4xl mx-auto px-6 space-y-16">
          ...
          <div className="bg-red-50 dark:bg-red-950/20 border-2 border-red-200 dark:border-red-900/50 rounded-2xl p-8 md:p-12">
            <div className="flex items-center gap-3 mb-6">
              <Ban className="w-8 h-8 text-red-600 dark:text-red-400 flex-shrink-0" strokeWidth={2} />
              <h2 className="text-3xl font-bold text-red-800 dark:text-red-400">Prohibited: Academic Use</h2>
            </div>
            <p className="text-red-800 dark:text-red-400 text-lg leading-relaxed font-bold mb-6">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">What is considered academic use?</h3>
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Why we prohibit academic use</h3>
            <div className="space-y-4 text-gray-700 dark:text-zinc-300 leading-relaxed">
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-3">
                  <span className="inline-block w-2 h-2 bg-red-600 dark:bg-red-400 rounded-full mt-2 flex-shrink-0" />
            ...
            <div className="bg-red-100 dark:bg-red-950/40 border border-red-300 dark:border-red-900/50 p-6 rounded-xl mt-8">
              <h4 className="text-sm font-bold text-red-800 dark:text-red-400 mb-2">Enforcement</h4>
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <CheckCircle2 className="w-8 h-8 text-emerald-600 dark:text-emerald-400 flex-shrink-0" strokeWidth={2} />
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Permitted: Professional Uses</h2>
            </div>
            <p className="text-gray-700 dark:text-zinc-300 text-lg leading-relaxed mb-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <Ban className="w-8 h-8 text-red-600 dark:text-red-400 flex-shrink-0" strokeWidth={2} />
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Other Prohibited Uses</h2>
            </div>
            <p className="text-gray-700 dark:text-zinc-300 leading-relaxed mb-6">
              In addition to academic use, the following activities are also prohibited:
            </p>
            <ul className="space-y-3 text-gray-700 dark:text-zinc-300 font-medium">
              {[
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <Shield className="w-8 h-8 text-brand-600 dark:text-brand-400 flex-shrink-0" strokeWidth={2} />
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Your Responsibility</h2>
            </div>
            <div className="space-y-4 text-gray-700 dark:text-zinc-300 leading-relaxed">
              <p>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3">
                    <span className="inline-block w-2 h-2 bg-brand-600 dark:bg-brand-400 rounded-full mt-2 flex-shrink-0" />
          ...
          <div className="border-t-2 border-brand-200 dark:border-zinc-700 pt-8">
            <p className="text-center text-sm text-gray-600 dark:text-zinc-400 mb-2">
              Questions about this policy? <Link href="/contact" className="text-brand-600 dark:text-brand-400 hover:underline font-semibold">Contact us</Link>
            </p>
            <p className="text-center text-sm font-bold text-gray-500 dark:text-zinc-500 italic">
      ...
      {/* CTA */}
      <section className="w-full py-20 px-6 bg-brand-50 dark:bg-zinc-900">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-6">Ready for professional-grade content humanization?</h2>
          <p className="text-gray-600 dark:text-zinc-400 text-lg mb-8 font-medium">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/terms" className="bg-white dark:bg-zinc-950 text-gray-900 dark:text-white px-8 py-3 font-medium rounded-lg border border-slate-200 dark:border-zinc-700 hover:bg-slate-50 dark:hover:bg-zinc-900 transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
