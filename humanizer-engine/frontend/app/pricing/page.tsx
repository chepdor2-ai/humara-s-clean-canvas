...
export default function PricingPage() {
  return (
    <div className="flex flex-col items-center">
      {/* Hero */}
      <section className="w-full pt-32 pb-16 bg-white dark:bg-slate-950">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 py-1.5 px-3 rounded-full bg-brand-50 dark:bg-brand-950 text-brand-700 dark:text-brand-300 text-xs font-medium mb-8 border border-brand-200 dark:border-brand-800">
            Simple Pricing
          </div>
      ...
      {/* Trust bar */}
      <section className="w-full py-12 bg-slate-50 dark:bg-slate-900 border-y border-slate-100 dark:border-slate-800">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <p className="text-xs font-medium text-slate-400 uppercase tracking-wider mb-5">Trusted by students and researchers at</p>
          <div className="flex flex-wrap justify-center gap-10 text-slate-300 dark:text-slate-600">
      ...
      <section className="w-full py-20 bg-white dark:bg-slate-950">
        <div className="max-w-2xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-semibold text-slate-900 dark:text-white mb-4">Need a custom plan?</h2>
          <p className="text-slate-500 dark:text-slate-400 mb-8">Enterprise volumes, custom integrations, or SLA requirements? Let&apos;s talk.</p>
