...
function VerifyContent() {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white dark:bg-zinc-900 rounded-2xl border border-slate-300 dark:border-zinc-700/60 shadow-2xl shadow-purple-900/10 p-8 text-center">
        {status === 'loading' && (
          <>
