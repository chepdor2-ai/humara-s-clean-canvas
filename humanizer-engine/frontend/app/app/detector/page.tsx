...
export default function DetectorPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] gap-6 px-6 animate-in fade-in duration-500">
      <div className="w-20 h-20 rounded-3xl bg-purple-950/40 border border-purple-800/40 flex items-center justify-center">
        <Shield className="w-10 h-10 text-purple-400" />
      </div>
      <div className="text-center space-y-2 max-w-md">
        <h1 className="text-2xl font-bold text-white tracking-tight">AI Detector</h1>
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-950/30 border border-amber-800/40 rounded-full">
