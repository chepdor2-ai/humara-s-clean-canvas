        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-6">
            {channels.map((ch) => {
              const Icon = ch.icon;
              return (
                <div key={ch.title} className="bg-slate-50 dark:bg-zinc-900 rounded-xl border border-slate-200 dark:border-zinc-800 p-6 hover:border-purple-800 hover:shadow-md transition-all">
                  <div className="w-10 h-10 bg-slate-200 dark:bg-zinc-800 rounded-lg flex items-center justify-center mb-4">
