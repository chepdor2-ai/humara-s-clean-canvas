...
export default function ContactForm() {
  ...
  if (status === 'success') {
    return (
      <div className="bg-white dark:bg-zinc-900 rounded-xl border border-emerald-800 p-8 text-center">
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white dark:bg-zinc-900 rounded-xl border border-slate-200 dark:border-zinc-800 p-6 md:p-8 space-y-5">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2.5 text-sm border border-slate-300 dark:border-zinc-700 rounded-lg bg-slate-100 dark:bg-zinc-800 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500"
      ...
      <div>
        <label className="block text-sm font-medium text-slate-600 dark:text-zinc-300 mb-1.5">Subject</label>
        <input
          type="text"
          value={form.subject}
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-4 py-2.5 text-sm border border-slate-300 dark:border-zinc-700 rounded-lg bg-slate-100 dark:bg-zinc-800 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500 resize-none"
