const DETECTOR_DOMAIN_RULES: Array<{ pattern: RegExp; domain: string }> = [
  ...
  { pattern: /undetectable/i, domain: "undetectable.ai" },
  { pattern: /kazan/i, domain: "kazanseo.com" },
  { pattern: /gltr/i, domain: "gltr.io" },
  { pattern: /detectgpt/i, domain: "detectgpt.com" },
  { pattern: /writefull/i, domain: "writefull.com" },
