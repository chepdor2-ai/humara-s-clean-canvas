...
export const AI_WORD_REPLACEMENTS: Record<string, string[]> = {
  ...
  holistic: ["well-rounded", "complete"], transformative: ["major", "radical", "significant"],
  innovative: ["new", "fresh", "creative"], groundbreaking: ["pioneering", "first-of-its-kind"],
  noteworthy: ["interesting", "notable"], proliferate: ["spread", "grow", "multiply"],
  exacerbate: ["worsen", "aggravate"], ameliorate: ["improve", "ease", "fix"],
  engender: ["create", "produce", "cause"], delineate: ["describe", "outline", "map out"],
  elucidate: ["explain", "clarify", "spell out"], illuminate: ["show", "clarify"],
  necessitate: ["require", "call for", "demand"], perpetuate: ["keep going", "continue", "maintain"],
  underscore: ["show", "stress", "bring out"], exemplify: ["show", "demonstrate", "reflect"],
  encompass: ["include", "cover", "take in"], bolster: ["support", "back up", "strengthen"],
  catalyze: ["trigger", "spark", "drive"], streamline: ["simplify", "cut down on", "trim"],
  optimize: ["improve", "fine-tune"], mitigate: ["reduce", "lessen", "soften"],
  navigate: ["handle", "work through", "deal with"], prioritize: ["focus on", "put first"],
  ...
  endeavor: ["try", "attempt", "effort"], delve: ["dig into", "look into", "examine"],
  ...
  myriad: ["many", "lots of", "countless"], plethora: ["many", "a lot of"],
  ...
  considerable: ["large", "a good deal of"], unprecedented: ["unmatched", "first-of-its-kind"],
  ...
  fundamentally: ["at its root", "in substance", "at a basic level"], arguably: ["probably", "you could say"],
  ...
  emphasize: ["stress", "point out", "underline"], establish: ["set up", "create", "form"],
  ...
  inextricably: ["closely", "tightly"],
  ostensibly: ["seemingly", "apparently"], quintessentially: ["at its core", "purely"],
  characteristically: ["typically"], quintessential: ["classic", "pure", "core"],
  ...
  seamless: ["smooth", "clean"], seamlessly: ["smoothly", "cleanly"],
  captivate: ["draw", "attract", "interest"], captivating: ["interesting", "engaging"],
  captivated: ["drawn", "interested"], captivates: ["draws", "attracts"],
  empower: ["enable", "allow", "give"], empowering: ["enabling", "helpful"],
  empowered: ["enabled", "able"], empowers: ["enables", "allows"],
  showcase: ["show", "present", "display"], showcasing: ["showing", "presenting"],
  showcased: ["shown", "presented"], showcases: ["shows", "presents"],
  highlight: ["show", "point out", "note"], highlighting: ["showing", "pointing out"],
  highlighted: ["shown", "noted"], highlights: ["shows", "points out"],
  leveraging: ["using", "drawing on"],
  leveraged: ["used", "drew on"],
  tailor: ["fit", "adjust", "adapt"], tailored: ["fitted", "adapted", "adjusted"],
  tailoring: ["fitting", "adapting"], tailors: ["fits", "adapts"],
  streamlined: ["simplified", "trimmed"],
  streamlining: ["simplifying", "trimming"], streamlines: ["simplifies", "trims"],
  reimagine: ["rethink", "reconsider"], reimagined: ["rethought", "reconsidered"],
  reimagines: ["rethinks", "reconsiders"],
  disrupting: ["changing", "upsetting"],
  disrupted: ["changed", "upset"], disruption: ["change", "upheaval"],
  innovate: ["create", "develop", "improve"],
  innovation: ["new idea", "change", "development"], innovations: ["new ideas", "changes"],
  paradigms: ["models", "approaches"],
  paradigmatic: ["typical", "standard"],
  scalable: ["expandable", "flexible"], scale: ["grow", "expand"],
  synergistic: ["combined", "joint"],
  synergies: ["combined gains", "shared benefits"],
  resonate: ["connect", "appeal"], resonates: ["connects", "appeals"],
  resonated: ["connected", "appealed"], resonating: ["connecting", "appealing"],
  holistically: ["as a whole", "overall"], comprehensively: ["thoroughly", "fully"],
  meticulously: ["carefully", "thoroughly"], thoughtfully: ["carefully", "with care"],
  intentionally: ["on purpose", "deliberately"], meaningfully: ["in a real way", "genuinely"],
  impactfully: ["effectively"],
  actionable: ["practical", "usable"], dynamic: ["active", "changing"],
  robustly: ["strongly", "solidly"],
  proactive: ["active", "forward-looking"], proactively: ["actively", "ahead of time"],
  incentivize: ["encourage", "motivate", "reward"],
  operationalize: ["put in practice", "implement", "carry out"],
  strategize: ["plan", "think ahead"], strategically: ["with care", "deliberately"],
  conceptual: ["theoretical", "abstract"], conceptually: ["in theory"],
  transformational: ["major", "significant"], transformationally: ["significantly"],
  insightful: ["useful", "thoughtful"], insightfully: ["usefully"],
  nuance: ["detail", "subtlety"], nuances: ["details", "subtleties"],
  nuancing: ["detailing"],
  iterative: ["step-by-step", "gradual"], iteratively: ["step by step", "gradually"],
  multidimensional: ["complex", "many-sided"],
  interconnected: ["linked", "related", "tied together"],
  interdisciplinary: ["cross-field", "mixed-field"],
  collaborative: ["joint", "shared", "group"], collaboratively: ["jointly", "together"],
  holism: ["whole-system thinking"], wholistic: ["complete", "overall"],
  impacting: ["affecting", "influencing"],
  overarchingly: ["broadly", "overall"],
  indispensable: ["essential", "vital", "needed"], indispensably: ["essentially"],
  manifold: ["many", "numerous"],
  unparalleled: ["unmatched", "exceptional"], incomparable: ["unmatched", "unique"],
  incomparably: ["remarkably", "exceptionally"],
  delving: ["looking", "examining"],
  delves: ["looks", "examines"], delved: ["looked", "examined"],
  embody: ["show", "represent", "capture"], embodies: ["shows", "represents"],
  embodied: ["showed", "represented"], embodying: ["showing", "representing"],
  encapsulate: ["sum up", "capture", "describe"], encapsulates: ["sums up", "captures"],
  encapsulated: ["summed up", "captured"],
  catalyzes: ["drives", "triggers"],
  catalyzed: ["drove", "triggered", "sparked"],
  underpin: ["support", "back up", "form the basis of"], underpins: ["supports", "backs up"],
  underpinned: ["supported", "backed up"],
  amalgamate: ["combine", "merge", "bring together"], amalgamating: ["combining", "merging"],
  amalgamated: ["combined", "merged"],
  spearheads: ["leads", "drives"],
  spearheaded: ["led", "drove", "headed"],
  cohesive: ["unified", "consistent", "clear"], cohesively: ["together", "consistently"],
};

export const AI_PHRASE_PATTERNS: [RegExp, string][] = [
  // ── Core AI telltale phrases ──────────────────────────────────────────────
  ...
  [/\bit is (?:also )?(?:important|crucial|essential|vital) to (?:understand|remember|consider|recognize|note|acknowledge)\b/gi, "worth noting,"],
  [/\bit is (?:worth|important) (?:noting|mentioning|emphasizing|highlighting|stressing|considering)\b/gi, "notably,"],
  [/\bit is necessary to\b/gi, "one must"],
  [/\bit goes without saying (?:that )?/gi, "clearly, "],
  [/\bneedless to say(?:,)?\s*/gi, "clearly, "],
  [/\bthere is no doubt that\b/gi, "clearly"],
  [/\bit is clear that\b/gi, "clearly"],
  [/\bit is (?:quite )?(?:clear|evident|apparent|obvious) that\b/gi, "clearly"],
  [/\b(?:it is|it remains) (?:clear|evident|apparent|obvious) that\b/gi, "clearly"],
  [/\b(?:it is|it remains) (?:true|the case) that\b/gi, ""],
  [/\bwithout a doubt,?\s*/gi, "clearly, "],
  [/\bthere is no question (?:that|about the fact that)\b/gi, "clearly"],
  [/\bof course,?\s*/gi, ""],
  [/\bnaturally,?\s*/gi, ""],

  // ── Today's world / era phrases ──────────────────────────────────────────
  [/\bin today'?s (?:world|society|landscape|era|age|environment|climate|context|digital age|fast-paced world)\b/gi, "today"],
  [/\bin the (?:modern|current|contemporary|present-day|digital|rapidly evolving) (?:era|age|world|landscape|context|environment)\b/gi, "today"],
  [/\bin an (?:ever-changing|ever-evolving|rapidly changing|fast-paced) (?:world|landscape|environment|era|age)\b/gi, "today"],
  [/\bever-(?:changing|evolving|growing|increasing)\b/gi, "changing"],
  [/\brapidly (?:evolving|changing|growing|advancing)\b/gi, "changing"],

  // ── Role / impact patterns ────────────────────────────────────────────────
  ...
  [/\bplays? a (?:crucial|vital|key|significant|important|pivotal|critical|fundamental|instrumental|central|essential|major) role\b/gi, "matters"],
  [/\bhas a (?:significant|major|profound|substantial|considerable|direct|indirect) (?:impact|effect|influence) on\b/gi, "affects"],
  [/\bhave a (?:significant|major|profound|substantial|considerable|direct|indirect) (?:impact|effect|influence) on\b/gi, "affect"],
  [/\bhad a (?:significant|major|profound|substantial|considerable|direct|indirect) (?:impact|effect|influence) on\b/gi, "affected"],
  [/\bsignificantly impacts?\b/gi, "affects"],
  [/\bcannot be overstated\b/gi, "matters greatly"],
  [/\bof (?:paramount|critical|crucial|vital) importance\b/gi, "very important"],
  [/\bof (?:great|significant|considerable|immense) (?:importance|significance|relevance|value)\b/gi, "important"],

  // ── Quantity/range patterns ───────────────────────────────────────────────
  ...
  [/\ba (?:growing|increasing|mounting|significant) number of\b/gi, "more"],
  [/\ban (?:increasing|growing|rising|mounting) number of\b/gi, "more"],
  [/\ba (?:substantial|considerable|significant|sizeable) (?:number|amount|portion|percentage|proportion) of\b/gi, "many"],
  [/\b(?:a )?(?:growing|increasing|mounting|emerging|expanding) body of (?:evidence|research|literature|work|data|studies)\b/gi, "more research"],
  [/\bnumerous (?:studies|researchers|scholars|experts|individuals|factors)\b/gi, "many $1"],
  ...
  [/\bas a (?:direct |indirect )?result of\b/gi, "because of"],
  [/\bas a (?:direct |indirect )?consequence of\b/gi, "because of"],

  // ── Listing / transitional openers ───────────────────────────────────────
  ...
  [/\bto wrap (?:things |this |it )?up,?\s*/gi, "overall, "],
  ...
  // ── Hedge / qualifier phrases ─────────────────────────────────────────────
  [/\b(?:that being said|having said that|with that (?:in mind|said),?)\b/gi, "still"],
  [/\b(?:in light of|in view of) (?:the above|this|these|the foregoing)\b/gi, "given this"],
  [/\bto (?:put it|say it) (?:simply|plainly|differently|another way|in (?:other|plain|simpler) words),?\s*/gi, "simply put, "],
  [/\bto elaborate(?:,)?\s*/gi, "to explain, "],
  [/\bto clarify(?:,)?\s*/gi, "to be clear, "],
  [/\bin other words,?\s*/gi, "put simply, "],
  [/\bthat is to say,?\s*/gi, "that is, "],
  [/\bone must (?:consider|note|keep in mind|bear in mind|remember)\b/gi, "note"],
  [/\bkeep in mind (?:that )?/gi, "note that "],
  [/\bbear in mind (?:that )?/gi, "note that "],
  [/\bas (?:mentioned|discussed|noted|stated|described|explained) (?:earlier|above|previously|before)\b/gi, "as noted"],
  [/\bas (?:previously|earlier|already) (?:mentioned|stated|discussed|noted|described)\b/gi, "as noted"],
  [/\bbuilding on (?:this|the above|the previous)\b/gi, "from there"],
  [/\bthis (?:goes|serves) to (?:show|illustrate|demonstrate|highlight|underscore)\b/gi, "this shows"],
  [/\bthis (?:is|serves as) a (?:reminder|testament|clear|prime|perfect) (?:example|illustration|demonstration)\b/gi, "this shows"],

  // ── Meta-textual AI phrases ───────────────────────────────────────────────
  [/\bthis (?:essay|article|blog|blog post|paper|piece|post|section|chapter|report) (?:will|aims to|seeks to|intends to|is going to|hopes to) (?:discuss|explore|examine|cover|address|analyze|outline|present|consider)\b/gi, ""],
  [/\bthe (?:purpose|aim|goal|objective|intent|intention) of this (?:essay|article|blog|blog post|paper|piece|post|section)\b/gi, "the aim here"],
  [/\bin this (?:essay|article|blog|blog post|paper|piece|post|section|chapter)\b/gi, "here"],
  [/\ballow me to (?:explain|discuss|outline|present|explore|walk you through|take you through)\b/gi, "to explain:"],
  [/\bI will (?:now )?(?:discuss|explain|explore|examine|cover|outline|address|walk you through)\b/gi, "the following covers"],
  [/\bwe will (?:now )?(?:discuss|explain|explore|examine|cover|outline|address)\b/gi, "the following covers"],
  [/\blet(?:'?s| us) (?:now )?(?:explore|discuss|examine|look at|consider|dive (?:in|into)|delve (?:in|into))\b/gi, "looking at"],
  [/\blet(?:'?s| us) (?:now )?(?:take a (?:closer |deep |deeper )?look at)\b/gi, "looking at"],
  [/\bwe (?:can|will|shall|should) (?:now )?(?:examine|explore|discuss|consider|look at|see)\b/gi, "looking at"],
  [/\bas we (?:can |shall |will |)(?:see|observe|note|explore|discuss|examine)\b/gi, "as seen"],
  [/\bwhen we (?:look at|consider|examine|think about|reflect on)\b/gi, "looking at"],
  [/\bif we (?:look at|consider|examine|think about)\b/gi, "looking at"],
  ...
  [/\bstrikingly(?:,)?\s*/gi, ""],
  [/\bimportantly(?:,)?\s*/gi, "notably, "],

  // ── Redundant intensifiers ────────────────────────────────────────────────
  [/\btruly\s+(?=(?:important|valuable|remarkable|significant|meaningful|vital|crucial|essential|interesting|fascinating))/gi, ""],
  [/\bdeep(?:ly)?\s+(?=(?:rooted|ingrained|embedded|connected|tied|linked|related|involved|integrated|committed|dedicated))\b/gi, ""],

  // ── Showcase / highlight / delve ─────────────────────────────────────────
  [/\bserves? as a (?:testament|reminder|catalyst|cornerstone|foundation|beacon|symbol)\b/gi, "shows"],
  [/\bserves? as (?:a )?(?:an |the )?(?:excellent|clear|strong|good|prime|perfect) example\b/gi, "shows"],
  ...
  [/\bexplores? (?:the )?(?:concept|notion|idea|topic|subject) of\b/gi, "examines"],
  [/\bunderscores? the (?:importance|significance|need|value|relevance)\b/gi, "shows the importance of"],
  [/\bhighlights? the (?:importance|significance|need|value|relevance)\b/gi, "shows the importance of"],
  [/\bshowcases? the (?:importance|significance|potential|power|value)\b/gi, "shows the"],
  [/\braises? (?:important |critical |key )?questions? (?:about|regarding|concerning)\b/gi, "raises questions about"],

  // ── "Not only...but also" ─────────────────────────────────────────────────
  [/\bnot only (.{5,80}?) but also\b/gi, "$1 and also"],
  [/\bnot only (.{5,80}?) but\b/gi, "$1 and"],

  // ── Research/findings boilerplate ────────────────────────────────────────
  ...
  [/\bstudies (?:have |)(?:shown|demonstrated|found|indicated|revealed|confirmed) that\b/gi, "research shows that"],
  [/\bresearch (?:has |)(?:shown|demonstrated|found|indicated|revealed|confirmed) that\b/gi, "research shows that"],
  [/\bevidence (?:suggests?|indicates?|shows?|demonstrates?) that\b/gi, "evidence shows that"],

  // ── Misc high-frequency AI patterns ──────────────────────────────────────
  [/\bmoving forward\b/gi, "from here"],
  [/\bgoing forward\b/gi, "from here"],
  [/\bin (?:order )?to\b/gi, "to"],
  [/\bas (?:a result|a consequence)\b/gi, "so"],
  [/\bfor (?:example|instance)\b/gi, "for example"],
  ...
  [/\ba comprehensive approach\b/gi, "a thorough approach"],
  [/\bthere is a (?:growing |increasing )?need (?:for|to)\b/gi, "there is need"],
  ...
  [/\bin (?:a |)(?:broader|wider|larger) (?:sense|context|perspective|framework)\b/gi, "broadly"],
  [/\bthe (?:complex|challenging|intricate) (?:nature|dynamics?) of\b/gi, "the complexity of"],
  [/\b(?:the )?key (?:takeaway|point|lesson|message|insight) (?:here )?(?:is|from this)\b/gi, "the main point is"],
  [/\bthe bottom line (?:is|here)\b/gi, "in short"],
  [/\bwhat this (?:means|tells us|shows|demonstrates|suggests|indicates)\b/gi, "this means"],
  [/\bto (?:put|say) this (?:more )?(?:simply|plainly|directly|bluntly|clearly)\b/gi, "simply put"],
  [/\bby doing so\b/gi, "through this"],
  [/\bthis can be seen (?:in|from|by)\b/gi, "evidence appears in"],
  [/\bthrough this (?:lens|framework|approach|perspective)\b/gi, "through this approach"],
  [/\bcutting-edge\b/gi, "advanced"],
  [/\bstate-of-the-art\b/gi, "advanced"],
  [/\bin-depth (?:analysis|examination|exploration|study|look)\b/gi, "close analysis"],
  ...
  [/\bamplifie[sd]?\b/gi, "increase"],
  [/\bamplif(?:y|ying)\b/gi, "increase"],
...
export const DIVERSITY_SWAPS: Record<string, string[]> = {
  // Only safe adjective/adverb swaps — no common verbs, nouns, or function words
  "big": ["sizable", "substantial"], "small": ["modest", "minor"],
  "bad": ["poor", "weak"],
  "important": ["key", "central"],
  "different": ["distinct", "varied"],
  "clear": ["plain", "evident"],
  "large": ["sizable", "considerable"],
...
const FORMAL_LINK_REPLACEMENTS: Record<string, string[]> = {
  ...
  "fundamentally": ["at its root", "in substance"],
...
const MARKER_FALLBACK_REPLACEMENTS: Record<string, string> = {
  ...
  "essentially": "in effect", "fundamentally": "at its root",
...
const TRACKED_CONNECTORS: Record<string, string[]> = {
  ...
  "meanwhile": ["at the same time", "at that point", "concurrently"],
...
function isProperOrAbbreviation(word: string): boolean {
  ...
  // Hyphenated compounds: preserve if any part is a proper noun/abbreviation (e.g. "AI-driven")
  if (stripped.includes('-')) {
    return stripped.split('-').some(part => part.length > 0 && isProperOrAbbreviation(part));
  }
  return false;
}
