...
const DEEP_SYNONYMS: [RegExp, string[]][] = [
  ...
  [/\bessentially\b/gi, ['in essence', 'basically', 'really', 'in practice']],
  ...
  [/\bspecifically\b/gi, ['in particular', 'namely', 'more precisely']],
  [/\bimproves?\b/gi, ['advances', 'boosts', 'raises', 'lifts']],
  [/\bimproved\b/gi, ['advanced', 'boosted', 'raised', 'lifted']],
  [/\bimproving\b/gi, ['advancing', 'boosting', 'raising']],
  [/\bbenefits?\b/gi, ['gains', 'advantages', 'perks', 'upsides']],
  [/\bfundamentally\b/gi, ['basically', 'in essence', 'at a deep level', 'in practice']],
