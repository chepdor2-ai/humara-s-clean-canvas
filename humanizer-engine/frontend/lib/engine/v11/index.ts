 ...
 * ========================================
 * 12-phase pipeline for AI text humanization.
 *
 ...
 *   4. ChunkRewrite   — optional LLM rewrite for high-AI chunks
 ...
 *  11. Rhythm         — burstiness ≥ 0.85 via aggressive split/merge/emphasis
...
export async function humanizeV11(
  ...
  // Create pipeline with all 13 phases (order matters!)
  const pipeline = new HumanizationPipeline([
    ...
    chunkRewritePhase,    // 4. Optional LLM chunk rewrite
    ...
    rhythmPhase,          // 11. Burstiness ≥ 0.85
