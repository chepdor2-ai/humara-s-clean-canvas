...
TONE_SETTINGS: dict[str, dict] = {
    "academic": {
        ...
        "formality": "high",
        "sentence_openers": [
            "Research shows that", "Studies confirm that", "The data reveal that",
            "Evidence points to", "What the literature shows is", "Scholars note that",
            "A key finding here is that", "The record suggests that",
        ],
    },
    "neutral": {
